...
as -o tokc.o src/token_classifier.s
...
ld -o crucible defs.o defs_error.o defs_file.o main.o opener.o reader.o closer.o lexer.o tokc.o exit.o bytes_table.o -e _start
